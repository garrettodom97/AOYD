...
function Downfall() {
  return (
    <div className="downfall-info">
      ...
      <h2>[Prologue]</h2>
      <h2>
        The intrepid crew of the Sol Techno-Conglomerate Starship, the S.T.C.S
        Downfall—a Progressive-Class vessel—was dispatched in response to a
        distress call from an allied world.{" "}
      </h2>
      <h2>[REVV]</h2>
      <h2>
        The S.T.C.S. Downfall jumped to FTL (Fast Than Light). While the
        Downfall zipped through space at 5x the speed of light, the crew
        prepared for the worst. Captain Cozza sat stoically at the center of the
        bridge, his chin resting thoughtfully on his fist as he stared out the
        viewscreen at the stars streaking by. The bridge crew worked diligently,
        moving from station to station like a well-choreographed dance to
        unheard music. Only hushed whispers and the thrum of the FLT engines
        could be heard.
      ...
      <h2>
        ...
        stood, jaw agape in unison with his crew. A black disk rimmed in
        ...
        chimed in, “that reminds me of this ancient earth movie where this horse
        gets sucked into a black—” Captain Cozza’s head snapped around as he
        gave Nicholson a stern gaze, prompting a sheepish look from his
        engineer. “S-sorry. Never… um…never mind, sir. It’s… it’s not
        important.”
        ...
        over the alarms.
        <br></br>“Damn!” Cozza growled. “Kru, full reverse!”
        <br></br>“Aye, Captain!” Kru responded. “Full reverse!”
        ...
        more power!”
        <br></br>“I’m giving you all she’s got, Captain!” Nicholson responded.
      </h2>
      ...
      <h2>
        ...
        speaking to him.
        <br></br>I am your end. I am the devourer of space and time itself. The
        author of galactic destruction… I am… the Author of Your Downfall…
      ...
      <h2>
        ...
        <br></br>“Garrett, sir!”
        <br></br>“Right!” Garrett was the newest member of the crew. “Garrett,
        ready weapons! Maybe we can disable or destroy whatever that is in
        there. I want a firing solution the moment we’re in range!”
        <br></br>“Aye, Captain!” Odom responded, his fingers flying over the
        console like a pianist to 88 keys.
        ...
        the bridge.
        <br></br>Warning. Structural Integrity at 74 percent and falling. The
        computer’s voice cut through the chaos.
        ...
        <br></br>Warning. Structural Integrity at 64 percent and falling.
        <br></br>A soft alarm sounded from engineering. “Got it!” Nicholson
        shouted triumphantly. “Putting it up on the viewscreen now!”
        <br></br>Warning. Structural Integrity at 60 percent and falling.
